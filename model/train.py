...
def main():
    ...
    dataset = DuckietownDataset('data_collection/dataset/', get_transform(train=True))
    dataset_test = DuckietownDataset('data_collection/dataset/', get_transform(train=False))
